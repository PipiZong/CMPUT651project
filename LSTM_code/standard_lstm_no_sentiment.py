...
#pickle.dump((embedding_matrix,train_dataset, test_dataset, test_index), open('Data/LSTM'+str(dimension)+'d_nosent.pkl',"wb"))
...
for epoch in range(n_epochs):
    ...
    print()
#pickle.dump((test_pred, test_true, test_index), open('Data/results/LSTM_pred_'+str(dimension)+'d_nosent.pkl',"wb"))
