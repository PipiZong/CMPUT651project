...
# load precessed comments with sentiments and Glove dictionary
dimension = 300
...
x_train, y_train, index = generate_sentence(comments_train)
#read other identities as multiple labels instead of just one label (target)
train = pd.read_csv('Data/train.csv')
train = train[train['id'].isin(index)]
...
# transfer to tensor data and load them into cuda for gpu use
...
#pickle.dump((predictions, y_test, test_index), open('Data/multilabel' + str(dimension) + 'd.pkl','rb'))
